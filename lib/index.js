...
function openapi_result_fcty(fittingDef, bagpipes) {
    ...
    return fittingDef.beautifyJson
      ? function openapi_result(ctx, next) {
            ...
            exports.assureStatusCode(ctx);
            exports.assureCorrectResponseContentType(ctx);
            exports.errorToOutputIfAny(ctx, fittingDef);

            exports.beautifyJsonContents(ctx, fittingDef);
